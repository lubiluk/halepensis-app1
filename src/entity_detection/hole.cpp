...
auto detect_holes(const boost::shared_ptr<point_cloud> &cloud, float pixel_radius)
-> std::vector<boost::shared_ptr<point_cloud>>
{
    ...
    for (int r = 0; r < rows; ++r) {
        ...
        for (int c = 0; c < cols; ++c) {
            point search_point;
            search_point.x = minX + c * pixel_radius;
            search_point.y =  minY + r * pixel_radius;
            search_point.z = 0.0f;
    ...
    std::vector<boost::shared_ptr<point_cloud>> holes;
