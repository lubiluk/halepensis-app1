...
public:
    ...
    task_understanding(boost::shared_ptr<point_cloud> before_cloud, const boost::shared_ptr<point_cloud> after_cloud);
...
private:
    auto add_features(const std::vector<boost::shared_ptr<point_cloud>>& clouds,
